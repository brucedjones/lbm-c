...
__device__ inline Node zh_pressure_x(Node input, float rho_boundary)
{
	...
	output.f[3] = input.f[4];
	output.f[4] = input.f[3];
	output.f[5] = input.f[6];
	output.f[6] = input.f[7];
	...
	output.f[9] = input.f[6] + ((1.f/2.f)*(input.f[2]-input.f[4])) + ((1.f/6.f)*output.rho*output.ux);
...
__device__ inline Node zh_pressure_X(Node input, float rho_boundary)
{
	...
	// COPY KNOWN f's
	output.f[0] = input.f[0];
	output.f[2] = input.f[1];
	output.f[3] = input.f[2];
	output.f[4] = input.f[4];
	output.f[5] = input.f[5];
	output.f[6] = input.f[8];
	...
	output.f[6] = input.f[9] - ((1.f/2.f)*(input.f[2]-input.f[4])) - ((1.f/6.f)*output.rho*output.ux);
